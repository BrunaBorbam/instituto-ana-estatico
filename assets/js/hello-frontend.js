...
(function () {
 ...
 function setup(){
  document.querySelectorAll("form.wpforms-form").forEach(function(form){
   ...
   const copy=document.createElement("span");copy.textContent="Autorizo o Instituto Ana a usar meu nome, telefone, e-mail e curso de interesse para responder à minha solicitação. Os dados serão armazenados no Supabase. Posso solicitar a exclusão pelo e-mail instituto.ana.xangrila@gmail.com.";
